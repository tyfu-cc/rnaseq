process STAR_ALIGN {
    ...
    output:
    tuple val(meta), path('*Log.final.out')   , optional: true, emit: log_final
    ...
    mv_unsorted_bam = (args.contains("--outSAMtype BAM Unsorted SortedByCoordinate")) 
    ...
    STAR \\
        ...
        --outSAMattrRGline ID:${prefix} SM:${prefix} PL:ILLUMINA LB:${prefix} PU:unit1
